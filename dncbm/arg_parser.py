...
def get_common_parser():
    ...
    # Added for the concept intervention
    parser.add_argument('--probe_similarity_model', type=str, default='sentence_transformer', help='Name of the model to use for similarity computation', choices=['bert', 'sentence_transformer', 'clip', 'glove', 'wordnet'])
    parser.add_argument('--penalty_lambda', type=float, default=1e-6, help='Lambda value for the penalty term (if the model uses unrelated concepts for classification)')
    parser.add_argument("--penalty_alpha", type=float, default=1e-4)
